...
class FrameStabilityWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent: QtWidgets.QWidget | None = None, *, show_file_controls: bool = True) -> None:
        super().__init__(parent)
    ...
    def _build_ui(self) -> None:
        ...
        root.addLayout(action_controls)
    ...
    def load_file(self) -> None:
        ...
        self.group_combo.addItems(self.sources)
        if not self.sources:
            ...
            return
        self.status_label.setText(
            f"Found {len(self.sources)} energy/group series. Select one, then reduce its raw frames for post-average QC."
        )
    ...
    def _analyze_cached_series(self, label: str, series: FrameSeries) -> None:
        ...
        self._plot_result(label, series, self.result)
    ...
    def _plot_result(self, label: str, series: FrameSeries, result: FrameStabilityResult) -> None:
        self.figure.clear()
...
class FrameStabilityDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent: QtWidgets.QWidget | None = None) -> None:
        ...
        self.widget = FrameStabilityWidget(self, show_file_controls=True)
