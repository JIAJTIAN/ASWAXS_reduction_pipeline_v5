...
def read_stitched_group_averages(combined_h5_path: Path, num_groups: int) -> list[object]:
    ...
    from aswaxs_live.reduction.aswaxs_sequence import GroupAverage  # pylint: disable=import-outside-toplevel
...
def _stack_component(component_lookup: list[dict[str, np.ndarray]], name: str) -> np.ndarray:
    from aswaxs_live.reduction.aswaxs_sequence import stack_ragged_rows  # pylint: disable=import-outside-toplevel
